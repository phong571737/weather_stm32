 ...
 ** uncomment the below #define EXT_FLASH_MAPPED **
 ******** end assign the correct value to *********
 ********* #define EXT_FLASH_BASEADDRESS **********
 ***** If external flash handled by TOUCHGFX,******
 ***** let #define EXT_FLASH_MAPPED commented *****
 **************************************************/
#define EXT_FLASH_MAPPED
...
#define EXT_FLASH_READING_PAGE	0XFF		//length of data read in 1 single reading command. Keep it below 0XFFFF due to HAL function limits
...
uint8_t 	Flash_Init(uint8_t *error);	//initialization: includes availability test and reset
void 		Flash_WaitForWritingComplete();
